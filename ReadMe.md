...
4. 使用 /ralph plan 命令让agent创建实施计划。 [ralph_agent.md] [ralph_plan.md]会作为提示词注入到agent中。然后读取spec文件创作出 BUILD_PLAN.md

5. 使用 /ralph build 命令让agent开发工程。 [ralph_agent.md] [ralph_build.md] 会作为提示词注入到agent中,agent会自己去读取BUILD_PLAN.md选择任务开始执行
